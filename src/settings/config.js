...
module.exports = {
    ...
    poruOptions: {
        ...
        clientID: process.env.SPOTIFY_ID || "eb90ecc197de461a9cf6f8148543c746", // <==== SPOTIFY CLIENT ID
        clientSecret: process.env.SPOTIFY_SECRET || "95a3c42b1d984f33955fc6e59b4042a2", // <==== SPOTIFY CLIENT SECRET
